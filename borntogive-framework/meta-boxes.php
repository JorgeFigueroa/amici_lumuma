...
$meta_boxes[] = array(
   ...
   'pages' => array('post', 'page', 'product', 'campaign', 'event', 'team'),
    'fields' => array(
        ...
        array(
            'name' => esc_html__('Slider Image', 'borntogive'),
            'id' => $prefix . 'pages_slider_image',
            'desc' => esc_html__("Enter Slider Image.", 'borntogive'),
            'type' => 'image_advanced',
        ),
		array(
...
$meta_boxes[] = array(
    ...
    'fields' => array(
		...
		array(
            ...
            'desc' => esc_html__("Enter the team member's Facebook.", 'borntogive'),
            'type' => 'text',
            'std' => '',
        ),
		array(
            ...
            'desc' => esc_html__("Enter the team member's Twitter.", 'borntogive'),
            'type' => 'text',
            'std' => '',
        ),
		array(
            ...
            'desc' => esc_html__("Enter the team member's Google Plus.", 'borntogive'),
            'type' => 'text',
            'std' => '',
        ),
		array(
            ...
            'desc' => esc_html__("Enter the team member's Pinterest.", 'borntogive'),
            'type' => 'text',
            'std' => '',
        ),
    )
