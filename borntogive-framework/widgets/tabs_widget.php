...
class borntogive_tabs_widget extends WP_Widget {
	...
	function widget($args, $instance) {
	   ...
	   $tags_number = apply_filters('widget_tabs_number', $instance['tags_no']);
	   
	   $numberPosts = (!empty($posts_number))? $posts_number : 3;	
	   $numberComments = (!empty($comments_number))? $comments_number : 3;	
	   $numberTags = (!empty($tabs_number))? $tabs_number : 10;	
		...
		if($posts_active == 1 || $comments_active == 1 || $tags_active == 1){
          	echo '<div class="tabbed_widgets tabs">
                 	<ul class="nav nav-tabs">';
                    	if($posts_active == 1){echo'<li> <a data-toggle="tab" href="#Trecent">Recent Posts</a> </li>';}
                    	if($comments_active == 1){echo'<li> <a data-toggle="tab" href="#Tcomments">Recent Comments</a> </li>';}
                    	if($tags_active == 1){echo'<li> <a data-toggle="tab" href="#Ttags">Post Tags</a> </li>';}
                echo '     	
                 	</ul>
