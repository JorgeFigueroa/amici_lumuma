...
//header options for page/post
    ...
    function pages_slider_display() {
        var $borntogive_pages_slider_image = jQuery('#borntogive_pages_slider_image_description').parent().parent();
		...
		var $borntogive_banner_image = jQuery('#borntogive_header_image_description').parent().parent();
		var $borntogive_pages_slider_height = jQuery('#borntogive_pages_slider_height').parent().parent();
		var $borntogive_pages_banner_description = jQuery('#borntogive_pages_banner_description').parent().parent();
            var $borntogive_pages_banner_color = jQuery('#borntogive_pages_banner_color').closest('.rwmb-field');
