                        ...
                        <div class="row">
                        	<div class="col-md-6 col-sm-6">
                                <span class="event-date">
                                    ...
                                    <span class="meta-data"><?php echo esc_attr(date_i18n('l', $this_date)); echo ' '.esc_attr(date_i18n(get_option('time_format'), $event_start_time));
								  if($event_end_time!='')
								  {
									  echo ' - '.esc_attr(date_i18n(get_option('time_format'), $event_end_time));
								  } ?></span>
                            ...
                            <div class="col-md-6 col-sm-6">
                                ...
                                <?php if($attendees!='')
                                   ...
                                   echo '<li class="list-group-item">'.$attendees.'<span class="badge">'.esc_html__('Attendees', 'borntogive').'</span></li>';
																...
																if($event_address!='')
																{
																	echo '<li class="list-group-item">'.$event_address.'<span class="badge">'.esc_html__('Location', 'borntogive').'</span></li>';
																}
																if($manager_name!='')
																{
