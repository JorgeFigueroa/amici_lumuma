...
$donation_achieved = $campaign->get_donated_amount();
$currency = '';
            	...
            	<div class="row">
                	<div class="col-md-<?php echo esc_attr($class); ?>" id="content-col">
                        ...
                        <div class="cause-progress-and-info">
                        	...
                        	<div class="progress">
                            	<div class="progress-bar progress-bar-primary" data-appear-progress-animation="<?php echo esc_attr($donated); ?>" data-appear-animation-delay="100"> <span class="progress-bar-tooltip"><?php echo esc_attr($donated); ?></span> </div>
                        	</div>
